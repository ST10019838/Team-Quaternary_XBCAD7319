...
export const columns: ColumnDef<Horse>[] = [
  ...
  },
  {
    ...
    header: "Years Worked",
    cell: ({ row }) => (
      <div className="text-right">{row.getValue("yearsWorked")}</div>
    ),
  },
  {
    ...
    cell: ({ row, table }) => {
      ...
      const [selectedSkill, setSelectedSkill] = React.useState(horse.skillLevel)

      const handleSkillChange = (newSkill: string) => {
        setSelectedSkill(newSkill as Horse["skillLevel"])
        horse.skillLevel = newSkill as Horse["skillLevel"]
        table.options.onDataChange?.(table.options.data)
      }
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem onClick={() => handleSkillChange("Beginner")}>
              Beginner
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleSkillChange("Intermediate")}>
              Intermediate
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleSkillChange("Advanced")}>
              Advanced
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
